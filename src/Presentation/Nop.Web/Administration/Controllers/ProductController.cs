...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        ///////////////////////////////////////////// bookmark
        public ActionResult Edit(ProductModel model, bool continueEditing, string checkStock = null, string modifyDOM = null)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
            ...
            if (Request["modifyDOM"] != null)
            {
                Crawler crawler = new Crawler();
                crawler.ModifyDOM(searchURL);
                TempData["searchURL"] = searchURL;
            ...
            if (ModelState.IsValid)
            {
                ...
                //product.Published = false; prod.Published = false;
        ...
        //public void CheckSupplierStock(int passedID)
        //{
        //    var targetProduct = _productService.GetProductById(passedID);

        //    Crawler crawler = new Crawler("availability out-of-stock", "http://www.goprocut.com/knives-tools/0-4065zg-8-ka-bar-dozier-folding-hunter-w-hole-zombie-green.html");

        //    int matchesFound = crawler.CrawlPage();
        ...
        {
            return View("_CheckSupplierStock");
        }
